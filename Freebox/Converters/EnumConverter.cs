...
public class EnumConverter : JsonConverter
{
        ...
        JsonSerializer serializer)
    {
        ...
        {
            throw new ArgumentException(LocalizedStrings.EnumConverter_WriteJson_Not_an_enum, nameof(value));
        }
        
        string enumName = Enum.GetName(enumValue.GetType(), enumValue);

        if (enumName == null) throw new ArgumentOutOfRangeException(nameof(value));
