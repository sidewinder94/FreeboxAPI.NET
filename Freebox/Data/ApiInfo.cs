...
public class ApiInfo
{
    ...
    {
        set => this.ApiVersion = new Version(value);
    }
    ...
    public Uri ApiUri => new Uri($"http{(this.IsHttpsAvailable ? "s" : "")}://{(this.IsHttpsAvailable ? this.ApiDomain : "mafreebox.freebox.fr") }:{(this.IsHttpsAvailable ? this.HttpsPort.Value.ToString(CultureInfo.InvariantCulture) : "80")}{this.ApiBase}");
}